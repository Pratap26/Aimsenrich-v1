...
<div class="row">
							...
							<tbody>
								...
								<tr>
									...
									<label style="color:red;padding:0.5em">Pending</label> <i class="fa fa-clock-o" aria-hidden="true"></i></td>
										...
										@endif
										<td>
											<form action="{{ route('assigned.trainer.delete', $class->id) }}" method="post">
												{{ csrf_field() }}
												<input type="hidden" name="_method" value="DELETE" >
												<button type="submit" class="btn btn-danger btn-xs" onclick="return confirm('Do you want to deassign this trainer?')">
	...
	{{ $classes->setPath("http://localhost:8000/dashboard/assign-traier/index") }}
</div>
</div>
@endsection