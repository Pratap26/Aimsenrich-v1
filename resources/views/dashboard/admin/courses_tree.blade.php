                                      ...
                                      @foreach($framework_units as $framework_unit)
                                        ...
                                        <div class="courseFrameworkUnit">
                                          <form action="{{ route('courseFrameworkUnit.destroy', $framework_unit->id) }}" method="POST" class="courseFrameworkHeading">
                                              ...
                                              @else
                                                <a href="{{ route('courseFrameworkSubmodule.create', ['unitid'=>$framework_unit->id,'coursePattern'=>$course->course_pattern]) }}">
                                                <i title="Add Subunit" class="fa fa-plus" aria-hidden="true"></i>
                                              </a>
                                          ...
                                          @foreach($framework_subunits as $framework_subunit)
                                            ...
                                            @foreach($subunits as $subunit)
                                               @if($framework_unit->id == $subunit->unit_id)
                                                <div class="subunit">
                                                {{$subunit->subunit_name}}
                                                        <a href="{{ route('courseFrameworkSubject.create', ['unitid'=>$framework_unit->id,'courseId'=>$course->course_id ,'']) }}">
                                                          <i title="Add Subunit" class="fa fa-plus" aria-hidden="true"></i>
                                                        </a>
                                                </div>
...
<a href="{{ route('category.create') }}">
  <button class="btn newBtn newCategoryBtn">New category</button>
</a>
<a href="{{ route('domain.create') }}">
  <button class="btn newBtn newDomainBtn">New domain</button>
</a>
<a href="{{ route('course.create') }}">
  <button class="btn newBtn newCourseBtn">New course</button>
</a>
